...
public class Pro_default_UIDLOGIN_KPI extends IReadWrite{
	...
	public String read(String caller,String date, int gameId, String ch) {
		try{
			String skey = RedisUtil.apply(date, ch, gameId, KPI.UIDLOGIN_KPI.raw());
			String ckey = RedisUtil.apply(date, ch, gameId, Action.LOGIN_ACTION.raw(),KPI.UIDLOGIN_KPI.raw());//计算key caculateKey
