...
public class Pro_default_UIDREG_KPI extends IReadWrite{
	...
	public String read(String caller,String date, int gameId, String ch) {
		try{
			String skey = RedisUtil.apply(date, ch, gameId, KPI.UIDREG_KPI.raw());
			String ckey = RedisUtil.apply(date, ch, gameId, Action.REG_ACTION.raw(),KPI.UIDREG_KPI.raw());//计算key caculateKey
