...
public class Pro_default_OLDPAYUSER_KPI extends IReadWrite{
	...
	public String read(String caller,String date, int gameId, String ch) {
		try{
			String skey = RedisUtil.apply(caller,date, ch, gameId, KPI.OLDPAYUSER_KPI.raw());
			String ckey = RedisUtil.apply(caller,date, ch, gameId, Action.PAY_ACTION.raw(),KPI.OLDPAYUSER_KPI.raw());//计算key caculateKey
